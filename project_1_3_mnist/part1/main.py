...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    test_error_3 = compute_test_error_mod3(test_x, test_y, theta, temp_parameter)
    # Save the model parameters theta obtained from calling softmax_regression to disk.
    write_pickle_data(theta, "./theta.pkl.gz")

    # TODO: add your code here for the "Using the Current Model" question in tab 4.
    #      and print the test_error_mod3
    return (test_error, test_error_3)
...
print('softmax mode_3 labels test_error:', run_softmax_on_MNIST_mod3())
...
def run_softmax_on_MNIST_18(temp_parameter=1):
    """
    Trains Softmax regression on digit (mod 3) classifications.
...
print('softmax PCA error:', run_softmax_on_MNIST_18())
...
print ("test error for cubic feature regression is :", run_softmax_on_MNIST_cube())
